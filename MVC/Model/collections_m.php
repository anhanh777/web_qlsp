...
class collections_m extends connectDB {
    // Hàm khởi tạo của lớp, tự động chạy khi đối tượng collections_m được tạo ra
    function __construct() {
        parent::__construct();
    }
    // Hàm lấy tất cả các bộ sưu tập và sắp xếp id theo giảm dần
